    ...
    render(){
      ...
      if (input!=undefined){
        Object.keys(this.props.data).map(key => (
          graphData.push(parseFloat(this.props.data[key]['4. close']))))
      } 
      return(
          <LineChart
            ...
            chartConfig={{
              ...
              backgroundGradientTo: this.props.up ? 'rgba( 107, 244, 169, 0.5)' : 'red',
              decimalPlaces: 2, // optional, defaults to 2dp
              color: (opacity = 1) => this.props.up ? 'rgba( 107, 244, 169)' : 'red',
              style: {
                borderRadius: 16
              }
            }}
